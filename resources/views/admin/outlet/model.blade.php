                                    ...
                                    <div class="addcharges">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="min_weight[]" id="min_weight" value="" class="form-control form-control-sm" placeholder="Enter minimum weight">
                                                <span id="min_weight_msg" class="custom-text-danger"></span>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Maximum Weight</label>
                                                <input type="text" name="max_weight[]" id="max_weight" value="" class="form-control form-control-sm" placeholder="Enter maximum weight">
